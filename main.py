...
#wpisujemy wygląd razem z graczem

gamedisplays=pygame.display.set_mode((display_width,display_height))
pygame.display.set_caption("zasoby\car game")
clock=pygame.time.Clock()
carimg=pygame.image.load('zasoby\car1.png')
backgroundpic=pygame.image.load("zasoby\download12.jpg")
yellow_strip=pygame.image.load("zasoby\yellow strip.png")
strip=pygame.image.load("zasoby\strip.jpg")
intro_background=pygame.image.load("zasoby/background.jpg")
instruction_background=pygame.image.load("zasoby/background2.jpg")
car_width=56
pause=False
...
#trzorzenia tła gry i wypisywanie zmiennych    
...
#dodawanie samochodów do gry

def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pic=pygame.image.load("zasoby\car.png")
    elif obs==1:
        obs_pic=pygame.image.load("zasoby\car1.png")
    elif obs==2:
        obs_pic=pygame.image.load("zasoby\car2.png")
    elif obs==3:
        obs_pic=pygame.image.load("zasoby\car4.png")
    elif obs==4:
        obs_pic=pygame.image.load("zasoby\car5.png")
    elif obs==5:
        obs_pic=pygame.image.load("zasoby\car6.png")
    elif obs==6:
        obs_pic=pygame.image.load("zasoby\car7.png")
    elif obs==7:
        obs_pic=pygame.image.load("zasoby\car8.png")
...
def game_loop():
    ...
    while not bumped:
        ...
        if obs_starty>display_height:
            ...
            obs=random.randrange(0,8)                                #WAŻNE!!!!!!!!!!!!!!!!!!!!!
            passed=passed+1
            score=passed*10
            if int(passed)%10==0:
                level=level+1
